    ...
    <div class="row mt-5">
        ...
        <div class="col-8">
            ...
            <table class="table" style="text-align: center;">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT obat.nama AS 'namaO', kategori,harga, stok, suplier.nama AS 'namaS' FROM obat INNER JOIN suplier on obat.kd_suplier = suplier.kd_suplier";
                    $data = mysqli_query($conn, $sql);
                    $no = (int)1;
                    foreach ($data as $rows) : ?>
                        <tr>
                            <td><?php echo $no++ ?></td>
                            <td><?php echo $rows['namaO'] ?></td>
                            <td><?php echo $rows['kategori'] ?></td>
                            <td><?php echo $rows['harga'] ?></td>
                            <td><?php echo $rows['stok'] ?></td>
                            <td><?php echo $rows['namaS'] ?></td>
